"""Reports page: per-person quarterly overview (per LEG) and plausibility checks."""
...
def auswertungen_page() -> None:
    ...
    with page_frame("/auswertungen", "Auswertungen"):
        ui.label(
            ...
            "unabhängig davon, ob bereits eine Abrechnung erstellt wurde) "
            "sowie Plausibilitätsprüfungen über die gesamten Stammdaten."
