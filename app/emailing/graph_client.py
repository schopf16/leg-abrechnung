...
#: Real invoice PDFs generated by this app are ~55 KB, far below it -- see
#: `app.pdf.person_bill_pdf` -- so the simpler upload-session flow for
#: larger files was deliberately not built.
...
async def send_email(
    ...
    *,
    ...
    Args:
        ...
        attachment_path: Optional PDF file to attach.
