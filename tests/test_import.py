...
def _make_messpunkt(messpunkt_bezeichnung: str, messrichtung: str, site_id: int) -> Messpunkt:
...
def test_import_file_stores_readings_for_known_messpunkte(db):
    ...
    messpunkt_repo.create(db, _make_messpunkt("CH1000000000000000000000001", MESSRICHTUNG_BEZUG, site_id))
    messpunkt_repo.create(db, _make_messpunkt("CH1000000000000000000000002", MESSRICHTUNG_EINSPEISUNG, site_id))
